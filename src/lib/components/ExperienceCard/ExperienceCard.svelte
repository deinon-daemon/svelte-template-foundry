...
<Card margin="0px 0px 20px 0px" tiltDegree={2} href={`${base}/about/${experience.slug}`}>
	<div class="col md:flex-row items-start gap-5 md:gap-1">
		<CardLogo src={getAssetURL(experience.logo)} alt={experience.role} size={75} />
		<div class="col ml-0 md:ml-[20px] gap-3 w-full">
			...
			<div class="row flex-wrap m-b-2 gap-1 text-0.9em font-300">
				<ChipIcon name={`Role: ${experience.role}`}>
